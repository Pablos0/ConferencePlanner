...
const ConferenceEvent = () => {
    ...
    const venueItems = useSelector((state) => state.venue); // retrives venue items from Redux store state
                    ...
                    <tbody>
                        {items.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td>{item.type === "meals" || item.numberOfPeople ? `${item.cost * numberOfPeople}`
    ...
    return (
     ...
     <div className="button_container">
        ...
        <div className="total_cost">Total Cost: ${venueTotalCost}</div>
                            ...
                            <div id="meals" className="venue_container container_main">
                                ...
                                <div className="input-container venue_selection">
                                    ...
                                    <input type="number" className="input_box5" id="numberOfPeople" value={numberOfPeople} 
                                        ...
                                        min="1" /* this code allow specify the amount of people with a minimun value of 1 */ />
                                </div>
                                <div className="meal_selection"> {/* Container */}
                                    {mealsItems.map((item, index) => (
                                        <div className="meal_item" key={index} style={{ padding: 15 }}> {/* key prop allows to react keep a track of each item */}
                                            <div className="inner">
                        ...
                        </div> /* totalCosts prop contains cost data and ItemsDisplay() component with items is passed as props to TotalCost component */
                    )
                }
...
// handleClick={handleToggleItems} -- should be in total_amount_detail code line
